...
def express_push(request):
    ...
    if phone is None or amount is None or account is None:
        return Response({'error': 'Please provide both phone number,account and Amount'}, status=HTTP_400_BAD_REQUEST)
